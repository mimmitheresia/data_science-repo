...
class TingentScraper(AbstractScraper):
    ...
    def extract_site_id(self, payload):
        try: return payload['abstract_id']
        except: return None


    def extract_job_title(self, payload):
        try: return payload['requisition_name']
        except: return None
                

    def extract_area(self, payload):
        try: return payload['requisition_servicecategoryid']
        except: return None
      

    def extract_due_date(self, payload):
        try: return payload['requisition_offerduedate']
        except: return None
    
    def extract_work_location(self, payload):
        try: return payload['requisition_locationid']
        except: return None
